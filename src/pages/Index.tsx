...
║                   ${paymentId.padEnd(42)}║
║                                                            ║
║                   ${receiptDate.padEnd(42)}║
║                                                            ║
╠════════════════════════════════════════════════════════════╣
║                                                            ║
║  Плательщик:          ${formData.fullName.padEnd(35)}║
║                                                            ║
║  Номер договора:                          ${formData.contractNumber.padEnd(17)}║
║                                                            ║
║  Способ оплаты:                           ${(paymentMethod === "card" ? "Банковская карта" : "СБП").padEnd(17)}║
║                                                            ║
╠════════════════════════════════════════════════════════════╣
║                                                            ║
║  Сумма:                        ${(parseFloat(formData.amount).toLocaleString('ru-RU') + ' ₽').padStart(27)}║
║                                                            ║
╠════════════════════════════════════════════════════════════╣
║                                                            ║
║                  ✓ СТАТУС: ОПЛАЧЕНО                        ║
